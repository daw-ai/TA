      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="h2 mb-4">Interpretation and Definitions</h2>
            <h3 className="h3 mb-4">Interpretation</h3>
            <p className="text-lg text-gray-600 mb-8">
              The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
            </p>
            <h3 className="h3 mb-4">Definitions</h3>
            <p className="text-lg text-gray-600 mb-8">
            ...
            <ul className="list-disc list-inside text-lg text-gray-600 mb-8">
              ...
              <li>
                <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Tech Ascension.
              </li>
              <li>
              ...
              <li>
                <strong>Website</strong> refers to Tech Ascension, accessible from <a href="https://www.techascension.com" class="text-blue-600 hover:underline">https://www.techascension.com</a>
              </li>
              <li>
                <strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.
              </li>
            </ul>
            <h2 className="h2 mb-4">Collecting and Using Your Personal Data</h2>
            <h3 className="h3 mb-4">Types of Data Collected</h3>
            <h4 className="h4 mb-4">Personal Data</h4>
            <p className="text-lg text-gray-600 mb-8">
            ...
            <h4 className="h4 mb-4">Usage Data</h4>
            <p className="text-lg text-gray-600 mb-8">
            ...
            <h4 className="h4 mb-4">Tracking Technologies and Cookies</h4>
            <p className="text-lg text-gray-600 mb-8">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies: <a href="https://www.freeprivacypolicy.com/blog/cookies/" target="_blank" class="text-blue-600 hover:underline">Cookies: What Do They Do?</a>
            </p>
            <p className="text-lg text-gray-600 mb-8">
            ...
            <h3 className="h3 mb-4">Use of Your Personal Data</h3>
            <p className="text-lg text-gray-600 mb-8">
            ...
            <h3 className="h3 mb-4">Retention of Your Personal Data</h3>
            <p className="text-lg text-gray-600 mb-8">
            ...
            <h3 className="h3 mb-4">Transfer of Your Personal Data</h3>
            <p className="text-lg text-gray-600 mb-8">
            ...
            <h3 className="h3 mb-4">Delete Your Personal Data</h3>
            <p className="text-lg text-gray-600 mb-8">
            ...
            <p className="text-lg text-gray-600 mb-8">
              You may update, amend, or delete Your information at any time by signing in to Your Account, if you have one, and visiting the settings section that allows you to manage Your personal information. You may also contact Us to request access to, correct, or delete any personal information that You have provided to Us.
            </p>
            <p className="text-lg text-gray-600 mb-8">
              Please note, however, that We may need to retain certain information when we have a legal obligation or lawful basis to do so.
            </p>
            <h3 className="h3 mb-4">Disclosure of Your Personal Data</h3>
            <h4 className="h4 mb-4">Business Transactions</h4>
            <p className="text-lg text-gray-600 mb-8">
              If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
            </p>
            <h4 className="h4 mb-4">Law enforcement</h4>
            <p className="text-lg text-gray-600 mb-8">
              Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
            </p>
            <h4 className="h4 mb-4">Other legal requirements</h4>
            <p className="text-lg text-gray-600 mb-8">
            ...
            <h3 className="h3 mb-4">Security of Your Personal Data</h3>
            <p className="text-lg text-gray-600 mb-8">
              The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.
            </p>
            <h3 className="h3 mb-4">Children's Privacy</h3>
            <p className="text-lg text-gray-600 mb-8">
            ...
            <h3 className="h3 mb-4">Links to Other Websites</h3>
            <p className="text-lg text-gray-600 mb-8">
            ...
            <h3 className="h3 mb-4">Changes to this Privacy Policy</h3>
            <p className="text-lg text-gray-600 mb-8">
            ...
            <ul className="list-disc list-inside text-lg text-gray-600 mb-8">
              <li>By email: info@techascension.com</li>
            </ul>
          </div>
        </div>
      </div>
